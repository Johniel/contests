...
namespace math {
  ...
  long long int vandermonde_convolution(int p, int q, int n) { return nCk(p + q, n); }
};
...
int main(int argc, char *argv[])
{
  ...
  while (cin >> n >> m >> k) {
    ...
    cout << (math::mod_comb(n + m, m) - math::mod_comb(n + m, m + k + 1) + mod) % mod << endl;
  }
  return 0;
}
