...
int main(int argc, char *argv[])
{
  ...
  while (cin >> n >> s) {
...

    {
      ...
      int b = v[1];
      int c = v[2];
      ++AB[vec<int>({a - min(a, b), b - min(a, b)})];
      ++BC[vec<int>({b - min(b, c), c - min(b, c)})];
      ++AC[vec<int>({a - min(a, c), c - min(a, c)})];
    }
    ...
    for (int i = 0; i < s.size(); ++i) {
      ...
      int b = v[1];
      int c = v[2];
      z += AB[vec<int>({a - min(a, b), b - min(a, b)})];
      z += BC[vec<int>({b - min(b, c), c - min(b, c)})];
      z += AC[vec<int>({a - min(a, c), c - min(a, c)})];
      ++ABC[v];
      ++AB[vec<int>({a - min(a, b), b - min(a, b)})];
      ++BC[vec<int>({b - min(b, c), c - min(b, c)})];
      ++AC[vec<int>({a - min(a, c), c - min(a, c)})];
