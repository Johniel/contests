...
int main(int argc, char *argv[])
{
  ...
  while (cin >> n) {
    ...
    vector<bool> x({false, true, false, true, false, true, false, true, false, true});
    vector<bool> y({false, true, false, true, true, false, true, true, false, true});
...
+ [repository](https://github.com/Johniel/contests/tree/master/atcoder/abc010/B)
