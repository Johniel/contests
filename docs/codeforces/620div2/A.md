# codeforces/620div2/A

## Codes
main.cpp
{% raw %}
```cpp
// codeforces/620div2/A/main.cpp
// author: @___Johniel
...
int main(int argc, char *argv[])
{
  ...
  while (cin >> x >> y >> a >> b) {
    ...
    if (fn(small) == 0) cout << small << endl;
    else if (fn(large) == 0) cout << large << endl;
    else cout << -1 << endl;
  }
...
+ [repository](https://github.com/Johniel/contests/tree/master/codeforces/620div2/A)
