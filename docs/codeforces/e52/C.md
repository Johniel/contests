# Educational Codeforces Round 52 C
上からkを超えない範囲で貪欲に取り除いて良い。ソートして累積和を持っておけば取り除かれるブロックの個数は高速に求められる。
...
+ [repository](https://github.com/Johniel/contests/tree/master/codeforces/e52/C)
